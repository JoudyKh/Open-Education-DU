 ...
 *     @OA\Property(property="theoretical_mark", type="number", format="double", example=75),  
 *     @OA\Property(property="practical_mark", type="number", format="double", example=85),  
