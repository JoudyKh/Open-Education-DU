...
namespace App\Http\Requests\Api\App\Student;
...
class UpdateStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'email' => 'email|string|unique:contact_infos,email,' . $student->id,
            'permanent_address' => '',
            'current_address' => '',
    ...
    {
        $student = Auth::guard('student')->user();
        $relatedFieldValue = $student->$relatedField;
