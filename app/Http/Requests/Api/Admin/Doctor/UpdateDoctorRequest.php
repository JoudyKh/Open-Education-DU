 ...
 *     ),  
 *    @OA\Property(
 *         property="delete_infos[0]",
 *         type="integer",
 *         description="An array of doctor infos IDs want to remove it from this doctor"
 *     ), 
 *    @OA\Property(
 *         property="delete_positions[0]",
 *         type="integer",
 *         description="An array of docto academic positions IDs want to remove it from this doctor"
 *     ), 
 *    @OA\Property(
 *         property="delete_achievements[0]",
 *         type="integer",
 *         description="An array of doctor achievements IDs want to remove it from this doctor"
 *     ), 
 * )  
 */
class UpdateDoctorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'email' => 'nullable|email|unique:doctors,email,' . $this->route('doctor')->id,
            ...
            'delete_infos' => 'array',
            'delete_infos.*' => 'required|exists:doctor_academic_infos,id,doctor_id,' . $this->route('doctor')->id,
            ...
            'delete_positions.*' => 'required|exists:doctor_academic_positions,id,doctor_id,' . $this->route('doctor')->id,
            ...
            'delete_achievements' => 'array',
            'delete_achievements.*' => 'required|exists:doctor_achievements,id,doctor_id,' . $this->route('doctor')->id,
        ];
    }
