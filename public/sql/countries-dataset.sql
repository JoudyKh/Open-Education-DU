INSERT INTO `countries` (`id`, `name_ar`, `name_en`, `code`) VALUES
(1, 'أندورا', 'Andorra', 'ad'),
...
INSERT INTO `cities` (`id`, `name_en`, `name_ar`, `code`, `country_id`) VALUES
